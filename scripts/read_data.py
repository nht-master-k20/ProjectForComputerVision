...
class ReadData:
    ...
    def run(cls):
        ...
        if full_df is not None:
            ...
            print(train_df[cls.TARGET_COLUMN].value_counts(normalize=True))
            print("\n--- Phân bổ nhãn trong tập Validation ---")
            print(val_df[cls.TARGET_COLUMN].value_counts(normalize=True))
            print("\n--- Phân bổ nhãn trong tập Test ---")
            print(test_df[cls.TARGET_COLUMN].value_counts(normalize=True))
            return True
        return False
